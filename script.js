    ...
    document.getElementById('btnLess').addEventListener('click', function () { 
        if (gameRun) {
            if (minValue === maxValue || minValue == answerNumber) {
                ...
                switch (phraseRandom) {
                    case 0:
                        answerPhrase = `Загаданное число неправильное!\n\u{1F914}`
                        break;

                    case 1:
                        answerPhrase = `Кажется Вы забыли загаданное число\n\u{1F92A}`
                        break;

                    case 2:
                        answerPhrase = `Число неверно!\n\u{1F9D0}`
                        break;

                    case 3:
                        answerPhrase = `Вы играете против правил!\n\u{1F620}`
                        break;
                }
                ...
                switch (phraseRandom) {
                    case 1:
                        answerPhrase = `Кажется, это число `
                        break;

                    case 2:
                        answerPhrase = `Ваше число `
                        break;
    ...
    document.getElementById('btnEqual').addEventListener('click', function () { 
        if (gameRun) {
            ...
            switch (phraseRandom) {
                ...
                case 2:
                    answerPhrase = `Это победа!\n\u{1F973}`
                    break;

                case 3:
                    answerPhrase = `Я и не сомневался!\n\u{1F929}`
                    break;
            }
            answerField.innerText = answerPhrase;
            gameRun = false;
